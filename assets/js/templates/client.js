...
new SimpleLightbox({
	...
	appendTarget: '.lightbox-wrapper', // append elsewhere if needed
})
...
galleryImages.forEach(image =>
{
	...
	{
		// Set interval for executing code after lightbox ist constructed
		setInterval(() =>
		{
			if(lightboxWrapper.hasChildNodes())
			{
				const lightboxImages = document.querySelectorAll('.lightbox-wrapper img')
